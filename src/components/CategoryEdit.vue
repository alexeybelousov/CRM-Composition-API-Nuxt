    ...
    <div>
      ...
      <form @submit.prevent="submit">
        ...
        <div class="input-field">
          ...
          <span v-if="isTitleInvalid" class="helper-text invalid">
        ...
        <div class="input-field">
          ...
          <span v-if="isLimitInvalid" class="helper-text invalid">
...
export default {
  setup(props, ctx) {
    ...
    const isTitleInvalid = computed(
      () => $v.titleField.$dirty && $v.titleField.$invalid
    )
    const isLimitInvalid = computed(
      () => $v.limitField.$dirty && $v.limitField.$invalid
    )
